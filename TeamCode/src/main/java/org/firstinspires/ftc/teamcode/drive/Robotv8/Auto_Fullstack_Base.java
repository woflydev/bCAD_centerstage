...
public class Auto_Fullstack_Base extends LinearOpMode {
    ...
    // note: constructor ----------------------------------------------------------------
    public Auto_Fullstack_Base(RobotAlliance alliance, RobotStartingPosition startPos, RobotParkingLocation parkLoc, RobotTaskFinishBehaviour finishBehaviour, Point r1, Point r2, Point r3) {
